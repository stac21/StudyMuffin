...
public class VirtualMeetingDialog {
    ...
    public VirtualMeetingDialog(Context context, String[] courseNamesArr) {
        AlertDialog.Builder dialog = new AlertDialog.Builder(context);

        View v = LayoutInflater.from(context).inflate(R.layout.virtual_meeting_dialog, null);
        Resources r = context.getResources();

        final EditText nameET = v.findViewById(R.id.name_et);
        final EditText descriptionET = v.findViewById(R.id.descriptionET);
        final EditText zoomLinkET = v.findViewById(R.id.zoom_link_et);
